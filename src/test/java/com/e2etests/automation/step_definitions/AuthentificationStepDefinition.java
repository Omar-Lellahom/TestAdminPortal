...
public class AuthentificationStepDefinition {
	...
	public void iLogIntoTheAdminPortalApplication() {
		...
		seleniumUtils.writeText(authentificationPage.Email, configFileReader.getProperties("mail"));
		seleniumUtils.writeText(authentificationPage.Password, configFileReader.getProperties("password"));
		seleniumUtils.click(authentificationPage.bouttonSignIn);
